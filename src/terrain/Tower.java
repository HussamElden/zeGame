...
public JLabel [] lbl =  new JLabel[3];
     ...
     Nation = nation;
      ...
      {
      lbl[1]=new JLabel(new ImageIcon(new ImageIcon("Pics//Tower_HumanHunters.png").getImage().getScaledInstance(100,150,Image.SCALE_DEFAULT)));
      ...
      {
       lbl[1]=new JLabel(new ImageIcon(new ImageIcon("Pics//Tower_NightElves.png").getImage().getScaledInstance(100,150 ,Image.SCALE_DEFAULT)));
